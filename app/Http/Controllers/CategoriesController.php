...
class CategoriesController extends Controller
{
    ...
    public function store(CategoryREquest $category)
    {
        ...
        //dd($data);
        return  redirect()->back()->with('success' , 'Tableau is add successfuly');
...
{
    $Tableaus = $category->Tableaus()->get();
   //dd($Tableaus);
   return view('DashbordAdmin.category.categoryShow' , compact('Tableaus' , 'category'));
}
